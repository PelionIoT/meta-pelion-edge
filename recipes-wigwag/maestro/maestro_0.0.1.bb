...
LIC_FILES_CHKSUM = "file://m/LICENSE;md5=543feeb21d5afbbe88012f44261f5217"
...
FILES_${PN} += "/wigwag/system/bin/* /wigwag/system/lib/* /wigwag/system/mud /wigwag/system/mud2" 
...
do_install() {
    ...
    # install -d "${D}/${bindir}"
    # install -d "${D}${WSB}"
    cp "${WORKSPACE}/src/github.com/WigWagCo/rallypointwatchdogs/rp100/rp100wd.so" "${D}/wigwag/system/lib"
    cp "${WORKSPACE}/src/github.com/WigWagCo/rallypointwatchdogs/dummy/dummywd.so" "${D}/wigwag/system/lib"
...
ALL_LIBS="libTW.a libprofiler.a libstacktrace.a libtcmalloc.la libtcmalloc_debug.a libtcmalloc_minimal.la libuv.a libgrease.so libprofiler.la libstacktrace.la libtcmalloc_and_profiler.a libtcmalloc_debug.la libtcmalloc_minimal_debug.a libgrease.so.1 libtcmalloc.a libtcmalloc_and_profiler.la  libtcmalloc_minimal.a libtcmalloc_minimal_debug.la"
	...
	cp $MAESTRO_LIBS/$f ${D}/wigwag/system/lib
